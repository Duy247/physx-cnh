...
Manifest JSON trong `physics/catalog/` là nguồn chuẩn. `public-snapshot.json` chứa các tài liệu đã biên mục; `inventory.json` theo dõi PDF và tệp nháp chưa đưa lên thư viện. PHP 8.1+ đọc snapshot tại chỗ và Hostinger là origin duy nhất.
