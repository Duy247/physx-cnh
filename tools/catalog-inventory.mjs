...
const competitionLabels = {
  ...
  aupho: 'Olympic Vật lý Úc (AuPhO)', baupc: 'Cuộc thi Vật lý Đại học Boston (BAUPC)',
  'bpho-r1': 'Olympic Vật lý Anh — Vòng 1 (BPhO)', 'bpho-r2': 'Olympic Vật lý Anh — Vòng 2 (BPhO)',
  'cpho-f': 'Olympic Vật lý Trung Quốc — Chung kết (CPhO)', eotvos: 'Cuộc thi Vật lý Eötvös',
  fma: 'Olympic Vật lý F=ma Hoa Kỳ', gpho: 'Olympic Vật lý Vùng Vịnh (GPhO)',
  hkpho: 'Olympic Vật lý Hồng Kông (HKPhO)', ispho: 'Olympic Vật lý Khoa học Quốc tế (ISPhO)',
  kphc: 'Cuộc thi Vật lý Trung học Hàn Quốc (KPHC)', usapho: 'Olympic Vật lý Hoa Kỳ (USAPhO)',
  usatst: 'Kỳ thi tuyển chọn đội tuyển Vật lý Hoa Kỳ (USATST)', wopho: 'Olympic Vật lý Mở Thế giới (WOPhO)',
  twpho: 'Olympic Vật lý Đài Loan (TwPhO)', twtst: 'Kỳ thi tuyển chọn đội tuyển Vật lý Đài Loan (TwTST)',
