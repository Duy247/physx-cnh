...
<?php foreach (array_unique($cssFiles) as $css): ?>
  <link rel="stylesheet" href="/assets/v2/css/<?= e($css) ?>.css?v=18">
<?php endforeach; ?>
</head>
...
<?php if (in_array($pageCss ?? '', ['hub', 'physics'], true)): ?><script type="module" src="/assets/v2/js/planetary.js?v=15"></script><?php endif; ?>
<?php if (($pageCss ?? '') === 'library'): ?><script src="/assets/v2/js/library.js?v=5" defer></script><?php endif; ?>
