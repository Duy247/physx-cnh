...
<?php foreach (array_unique($cssFiles) as $css): ?>
  <link rel="stylesheet" href="/assets/v2/css/<?= e($css) ?>.css?v=29">
<?php endforeach; ?>
</head>
...
<?php if (in_array($pageCss ?? '', ['hub', 'physics'], true)): ?><script type="module" src="/assets/v2/js/planetary.js?v=19"></script><?php endif; ?>
